...
def main():
    ...
    #It will loop as long as the user said yes to playagain
    while playAgain == "yes":
        #must re-seed the loop
        menuChoice = ""

        #This is the inner loop it will loop until the user types A, B, C, D
        ...
        playAgain = input("Do you want to play again? ") #"yes"
